    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gptlawyer.chat')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gptlawyer.studycase')),
            ],
        ),
        migrations.AddField(
            model_name='chat',
            name='study_case',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gptlawyer.studycase'),
        ),
        migrations.CreateModel(
            name='Collaborator',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='study_cases_contributed', to=settings.AUTH_USER_MODEL)),
                ('study_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gptlawyer.studycase')),
            ],
            options={
